...
- Per-role assignment TODOs: [implementation/tasks/README.md](implementation/tasks/README.md)
- Team implementation workspace: [implementation/README.md](implementation/README.md)
